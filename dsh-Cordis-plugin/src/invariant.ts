/**
 * Package-owned invariant companion for `@dsh-external/dsh-ui-grokbot`.
 * @module @dsh-external/dsh-ui-grokbot/invariant
 */
...
export const name = 'dsh-ui-grokbot-invariant'
